...
describe('Tile', () => {
    ...
    it('CompareTiles, a and b, where a < b returns -1', () => {
        let a : Tile = new Tile(0);
        let b : Tile = new Tile(20);
        expect(CompareTiles(a, b)).to.equal(-1);
    });

    it('CompareTiles, a and b, where a > b returns 1', () => {
        let a : Tile = new Tile(20);
        let b : Tile = new Tile(0);
        expect(CompareTiles(a, b)).to.equal(1);
    });
