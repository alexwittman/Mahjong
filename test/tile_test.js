...
// import { Tile, TileType, TileValue, CompareTiles, CopyTileList, TileListCount, IndexTileList, TileList, TileListEqual } from '../src/game/tile';

expect = require('chai').expect;
Tile = require('../src/game/tile').Tile;
let TileType = require('../src/game/tile').TileType;
CompareTiles = require('../src/game/tile').CompareTiles;
let CopyTileList = require('../src/game/tile').CopyTileList;
let TileListCount = require('../src/game/tile').TileListCount;
let IndexTileList = require('../src/game/tile').IndexTileList;
TileList = require('../src/game/tile').TileList;
let TileValue = require('../src/game/tile').TileValue;
let TileListEqual = require('../src/game/tile').TileListEqual;
